                ...
                <div class="col-md-6 bg-light">
                    ...
                    <div class="btn-group col-md-12">
                        ...
                        <div class="col-md-8 bg-light">
                                <span>${product.productName} by <b>${product.productBrand} </b></span><span class="fa fa-pencil-square" aria-hidden="true"></span>
                        ...
                        <div class="col-md-4 bg-light"> 
                                     <br>  <br> <br>          <br>                      
        <span style="color: gray">${product.productDescription}</span><span class="fa fa-pencil-square" aria-hidden="true"></span>
