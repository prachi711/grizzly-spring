    ...
    <div class="container-fluid">
      <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <select name="category">
                        ...
                        <input type="text" name="pDescription" placeholder="Description" required>
        ...
        <div class="col-md-3">
           ...
           <button class="btn btn-secondary form-rounded" style="width:30%;  position: absolute; bottom: 50px; right: 20px;" type="submit">Submit
           </button>
      ...
      <a href="Admin-ListProducts.html">List Product</a>
      </body>
    </html>