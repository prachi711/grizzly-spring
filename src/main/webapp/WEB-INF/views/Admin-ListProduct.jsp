...
<option value="">Select-Sorting Type</option>
 ...
 <option value="http://localhost:8020/GrizzlyStore/SortByRatingServlet?order=HighToLow">High To Low</option>
		...
		<form class= "mx-2 my-auto w-full" action="AddProduct.html" method="POST">
                                                       ...
                                                       <a href="AddProduct.html" class="btn btn-dark form-rounded" >Add Product</a>
					</form>
<form>
                        </div>
                                     ...
                                     <table border="1" class="table table-bordered">
                                            <tr>
                                                <td>
                                                    <center><span style="color: gray">Product Id</span>
                                                </td>
                                                <td>
                                                        <center> <span style="color: gray">Category</span>
                                                    </td>
                                                    <td>
                                                            <center><span style="color: gray">Product Name</span>
                                                        </td>
                                                        <td>
                                                                <center><span style="color: gray">Description</span>
                                                            </td>
                                                            <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <center>
                              <a href="FetchProductServlet?id=${products.pId}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;View&emsp; 
                              </a>&emsp;&emsp;
								<input id="prodId" name="userId" type="hidden" value="">
                              <button class="btn btn-secondary form-rounded" type="button"> &emsp;Block&emsp; 
                              </button>&emsp;&emsp;
                              <a  href="DeleteProductServlet?id=${products.pId }" class="btn btn-secondary form-rounded">&nbsp;Remove&nbsp; 
                              </a>
                            </center>
                          </td>
                        </tr>
