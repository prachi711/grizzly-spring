package com.cts.grizzlywebstore.configuration;
...
@ComponentScans(value={@ComponentScan("com.cts.grizzlywebstore.dao"),
                        @ComponentScan("com.cts.grizzlywebstore.service")})
...
public class AppConfig {
	...
	public org.springframework.orm.hibernate5.LocalSessionFactoryBean getSessionFactory(){
		...
		Properties properties=new Properties();//instance
		...
		//sessionFactoryBean.setAnnotatedClasses(lo.class); 
		sessionFactoryBean.setPackagesToScan("com.cts.grizzlywebstore.bean");
